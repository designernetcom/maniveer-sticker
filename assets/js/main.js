!(function (e) {
      ...
      jQuery
        ...
        .done(function (t) {
          g.removeClass("error"),
            g.addClass("success"),
            g.text(t),
            e(f + ' input:not([type="submit"]),' + f + " textarea").val("");
        })
        .fail(function (e) {
  ...
  new WOW().init(),
    ...
    e(".testi-card-2-tab").length &&
      e(".testi-card-2-tab").asTab({ sliderTab: !0, tabButton: ".tab-btn" }),
    e(".service-tab-menu").length &&
      e(".service-tab-menu").asTab({ sliderTab: !0, tabButton: ".tab-btn" }),
    b(),
    e(window).scroll(b),
